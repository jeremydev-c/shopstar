...
"[project]/g/ecommerce-platform/frontend/app/cart/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartPage() {
    ...
    const updateQuantity = async (itemId, quantity)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$g$2f$ecommerce$2d$platform$2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/cart/${itemId}`, {
                quantity
            });
            fetchCart();
        } catch (error) {
    ...
    const removeItem = async (itemId)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$g$2f$ecommerce$2d$platform$2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/cart/${itemId}`);
            fetchCart();
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__30580eda._.js.map